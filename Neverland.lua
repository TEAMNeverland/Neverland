...
os.execute('lua Neverlandteam.lua')
end
...
local Num_Msg_Neverland = Redis:hget(TheNeverland.."Neverland:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
...
Num_Msg_Neverland = Redis:hget(TheNeverland.."Neverland:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
os.execute('rm -rf Neverlandteam.lua')
download('https://raw.githubusercontent.com/NeverlandTeam2/TeamNeverland/main/Neverlandteam.lua','Neverlandteam.lua')
